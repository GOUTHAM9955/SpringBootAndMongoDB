 ...
 * 		WE COPIED THIS DTO OBJECT TO MODEL OBJECT USING BeanUtils(It doesn’t throw an error if a field is missing[id filed isn't there in CustomerDto]) IN SERVICE LAYER... CHECK IT
...
public class MongoDbLauncher1Application {
	...
	public static void main(String[] args) {
		...
		CustomerService customerService = context.getBean(CustomerService.class);
		  ...
		  CustomerDto customerDto = new CustomerDto(4,"Koushik","Hyd2");
